      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto" data-testid="contact-description">
            Get in touch with our team to discuss your medical cannabis export requirements
          </p>
        </div>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed mb-8" data-testid="contact-info-description">
                We're here to help with your medical cannabis export needs. Contact us to discuss compliance requirements, supply chain solutions, or partnership opportunities.
              </p>
            </div>
